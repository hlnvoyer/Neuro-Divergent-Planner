...
class AlarmsListViewWithPopupMenuButton extends StatefulWidget {
  @override
  _AlarmsListView createState() => new _AlarmsListView();
}

class _AlarmsListView extends State<AlarmsListViewWithPopupMenuButton> {
